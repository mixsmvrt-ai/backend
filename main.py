...
STUDIO_PRESETS: list[StudioPreset] = [
    ...
    StudioPreset(
        id="afrobeat_vocal_silk",
        name="Afrobeat Vocal Silk",
        mode="mixing_only",
        target="vocal",
        genre="afrobeat",
        description="Smoother afrobeat vocal with extra width and softer top.",
        dsp_chain_reference="afrobeat",
        tags=["Vocal", "Afrobeat", "Smooth"],
    ),
    StudioPreset(
    ...
    StudioPreset(
        id="trap_dh_lead_air",
        name="Trap/Dancehall Lead Air",
        mode="mixing_only",
        target="vocal",
        genre="trap_dancehall",
        description="Modern trap-dancehall lead with bright top and tight lows.",
        dsp_chain_reference="trap_dancehall",
        tags=["Vocal", "Trap", "Dancehall"],
    ),
    StudioPreset(
        id="hiphop_vocal_clarity",
        name="Hip-Hop Vocal Clarity",
        mode="mixing_only",
        target="vocal",
        genre="hiphop",
        description="Focused hip-hop vocal preset emphasizing intelligibility and punch.",
        dsp_chain_reference="hiphop",
        tags=["Vocal", "Hip-Hop", "Clear"],
    ),
    StudioPreset(
        id="clean_pop_vocal",
    ...
    StudioPreset(
        id="trap_beat_knock",
        name="Trap Beat Knock",
        mode="mixing_only",
        target="beat",
        description="Extra punch and knock for modern trap 808 beats.",
        dsp_chain_reference="streaming_master",
        tags=["Beat", "Trap", "Punch"],
    ),
    StudioPreset(
        id="afrobeat_club_beat",
        name="Afrobeat Club Beat",
        mode="mixing_only",
        target="beat",
        description="Club-focused afrobeat instrumental polish with controlled lows.",
        dsp_chain_reference="streaming_master",
